...
namespace LimepayApi.Net.Models
{
    ...
    /// <summary>
    /// The CardStatement object
    /// </summary>
    [DataContract]
    public partial class CardStatement :  IEquatable<CardStatement>, IValidatableObject
    {
        /// <summary>
        ...
        public CardStatement(string Name = default(string), string City = default(string))
        {
            this.Name = Name;
            this.City = City;
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as CardStatement);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(CardStatement other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
